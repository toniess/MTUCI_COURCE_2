...
namespace СrmTest
{
    public partial class Question7 : Form
    {
        ...
        private void Question7_Resize(object sender, System.EventArgs e)
        {
        ...
        {
            Lib.CheckQ7(answerBox, MainPage.resultArray, MainPage.qIndex);
            Lib.configureButton(bQuest7, check, MainPage.resultArray, MainPage.qIndex, MainPage.qIndex);
        }

        private void Question7_VisibleChanged(object sender, System.EventArgs e)
        {
            if (this.Visible)
                foreach (Button b in splitContainer2.Panel2.Controls)
                {
