...
namespace СrmTest
{
    public partial class Question14 : Form
    {
        ...
        private void Question14_Resize(object sender, System.EventArgs e)
        {
        ...
        private void answer_Scroll(object sender, System.EventArgs e)
        {
            currentValue.Text = answer.Value.ToString();
            int x = answer.Width / 20 * answer.Value - 23;
            currentValue.Location = new Point(x, answer.Location.Y + 30);
        ...
        private void check_Click(object sender, System.EventArgs e)
        {
            ...
            Lib.CheckQ14(answer, MainPage.resultArray, MainPage.qIndex);
            Lib.configureButton(bQuest14, check, MainPage.resultArray, MainPage.qIndex, MainPage.qIndex);
        }

        private void answer_VisibleChanged(object sender, System.EventArgs e)
        {
            if (this.Visible)
                foreach (Button b in splitContainer2.Panel2.Controls)
                {
        ...
        private void Question14_VisibleChanged(object sender, System.EventArgs e)
        {
            if (this.Visible)
                foreach (Button b in splitContainer2.Panel2.Controls)
                {
