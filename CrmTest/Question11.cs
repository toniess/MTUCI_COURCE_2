...
namespace СrmTest
{
    public partial class Question11 : Form
    {
        ...
        private void Question11_Resize(object sender, System.EventArgs e)
        {
        ...
        {
            Lib.CheckQ11(answerBox1, answerBox2, answerBox3,
                MainPage.resultArray, MainPage.qIndex);
            Lib.configureButton(bQuest11, check, MainPage.resultArray, MainPage.qIndex, MainPage.qIndex);
        }

        private void Question11_VisibleChanged(object sender, System.EventArgs e)
        {
            if (this.Visible)
                foreach (Button b in splitContainer2.Panel2.Controls)
                {
