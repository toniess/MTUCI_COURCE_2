...
namespace СrmTest
{
    public partial class Question2 : Form
    {
        ...
        private void Question2_Resize(object sender, System.EventArgs e)
        {
        ...
        {
            Lib.CheckQ2(answerBox1, answerBox2, answerBox3, answerBox4,
                 MainPage.resultArray, MainPage.qIndex);
            Lib.configureButton(bQuest2, check, MainPage.resultArray, MainPage.qIndex, MainPage.qIndex);
        }

        private void Question2_VisibleChanged(object sender, System.EventArgs e)
        {
            if (this.Visible)
                foreach (Button b in splitContainer2.Panel2.Controls)
                {
