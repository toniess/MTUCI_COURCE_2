...
namespace СrmTest
{
    public partial class Question10 : Form
    {
        ...
        private void Question10_Resize(object sender, System.EventArgs e)
        {
        ...
        {
            Lib.CheckQ10(answerBox, MainPage.resultArray, MainPage.qIndex);
            Lib.configureButton(bQuest10, check, MainPage.resultArray, MainPage.qIndex, MainPage.qIndex);
        }

        private void Question10_VisibleChanged(object sender, System.EventArgs e)
        {
            if (this.Visible)
                foreach (Button b in splitContainer2.Panel2.Controls)
                {
