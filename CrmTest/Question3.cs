...
namespace СrmTest
{
    public partial class Question3 : Form
    {
        ...
        private void Question3_Resize(object sender, System.EventArgs e)
        {
        ...
        {
            Lib.CheckQ3(answerBox1, answerBox2, answerBox3,
                        answerBox4, answerBox5, answerBox6,
                        MainPage.resultArray, MainPage.qIndex);
            Lib.configureButton(bQuest3, check, MainPage.resultArray, MainPage.qIndex, MainPage.qIndex);
        }

        private void Question3_VisibleChanged(object sender, System.EventArgs e)
        {
            if (this.Visible)
                foreach (Button b in splitContainer2.Panel2.Controls)
                {
