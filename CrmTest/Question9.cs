...
namespace СrmTest
{
    public partial class Question9 : Form
    {
        ...
        private void Question9_Resize(object sender, System.EventArgs e)
        {
        ...
        {
            Lib.CheckQ9(answerBox, MainPage.resultArray, MainPage.qIndex);
            Lib.configureButton(bQuest9, check, MainPage.resultArray, MainPage.qIndex, MainPage.qIndex);
        }

        private void Question9_VisibleChanged(object sender, System.EventArgs e)
        {
            if (this.Visible)
                foreach (Button b in splitContainer2.Panel2.Controls)
                {
